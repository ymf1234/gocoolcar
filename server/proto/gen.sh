...
$PBTS_BIN_DIR/pbjs -t static -w es6 trip.proto --no-create --no-create --no-encode --no-decode --no-verify --no-delimited -o $PBTS_OUT_DIR/trip_pb_tmp.js
...
rm -rf $PBTS_OUT_DIR/trip_pb_tmp.js
